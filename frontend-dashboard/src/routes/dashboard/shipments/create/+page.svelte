  ...
  onMount(async () => {
    try {
      ...
      if (error instanceof Error) {
        ...
        transportError =
          "Ocurrió un error inesperado al cargar los métodos de transporte.";
      }
    } finally {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (error.response) {
        ...
        errorMessage =
          "Error de red o CORS. Verifique la conexión y la configuración del servidor.";
      }
    } finally {
      isLoading = false;
    }
    ...
    <div class="details-grid">
                ...
                <div class="transport-options">
                  {#each transportMethods as method}
                    <label
                      ...
                      class:selected={transport_type === method.name}
                    >
                      <input
                        type="radio"
                        bind:group={transport_type}
                        name="transport_type"
                        value={method.name}
                      />
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input
                ...
                readonly
                placeholder="Se autocompleta con la localidad"
              />
            </div>
          </div>
        </div>
      ...
      <div class="grid-col">
        <div class="info-card">
          ...
          <button type="button" on:click={addProduct} class="add-btn"
